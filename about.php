        ...
        <main>
                ...
                <div class="container max-w-screen-xl mx-auto">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div class="xl:mr-20">
                            ...
                            <a class="btn-gh xl:hover:bg-dviolet xl:hover:text-ghost transition ease-in-out duration-500 dark:border-ghost" href="#contact">Get in touch</a>
                        </div>
                        <img class="rounded-full shadow-vi justify-self-center self-center w-5/6 sm:w-4/6" src="images/jessicamlee_profilepicture.jpg" alt="Jessica Lee Profile Picture">
                    </div>
                </div>
            </section>
            <section class="bg-gray-300 px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 md:py-12 lg:py-14 dark:bg-dviolet dark:text-ghost">
                <div class="container max-w-screen-xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8">
                        ...
                        <div class="grid grid-cols-6 gap-x-2 md:gap-x-3">
                            <div class="mt-4 flex justify-center self-start">
                                <svg class="w-12 h-16 hover:animate-bounce ease-in-out delay-75 fill-dviolet dark:fill-ghost dark:border-ghost" viewBox="0 0 55 67" xmlns="http://www.w3.org/2000/svg" alt="Violet person with waving hand icon" title="Bouncing person with waving hand icon">
                                    <path d="M26.4998 13.7502C30.1357 13.7502 33.0832 10.8027 33.0832 7.16683C33.0832 3.53095 30.1357 0.583496 26.4998 0.583496C22.864 0.583496 19.9165 3.53095 19.9165 7.16683C19.9165 10.8027 22.864 13.7502 26.4998 13.7502Z"/>
                                    <path d="M39.3045 20.6956C38.0208 19.4118 35.8154 17.0418 31.5362 17.0418C30.845 17.0418 26.862 17.0418 23.1754 17.0418C14.1233 17.0089 6.74996 9.63558 6.74996 0.583496H0.166626C0.166626 10.9852 7.11204 19.8068 16.625 22.6706V66.4168H23.2083V46.6668H29.7916V66.4168H36.375V27.0814L49.377 40.0835L54.0183 35.4422L39.3045 20.6956Z"/>
                                </svg>
                            </div>
                            <div class="col-span-5 ml-2">
                        ...
                        <div class="grid grid-cols-6 gap-x-2 md:gap-x-3">
                            <div class="mt-4 flex justify-center self-start">
                                <svg class="w-12 h-14 hover:animate-bounce ease-in-out delay-75 fill-dviolet dark:fill-ghost dark:border-ghost" viewBox="0 0 47 67" xmlns="http://www.w3.org/2000/svg" alt="Violet outlined lightbulb icon" title="Bouncing lightbulb icon">
                                    <path d="M13.625 63.1252C13.625 64.9356 15.1063 66.4168 16.9167 66.4168H30.0834C31.8938 66.4168 33.375 64.9356 33.375 63.1252V59.8335H13.625V63.1252ZM23.5 0.583496C10.7942 0.583496 0.458374 10.9193 0.458374 23.6252C0.458374 31.4593 4.37546 38.3389 10.3334 42.5193V49.9585C10.3334 51.7689 11.8146 53.2502 13.625 53.2502H33.375C35.1855 53.2502 36.6667 51.7689 36.6667 49.9585V42.5193C42.6246 38.3389 46.5417 31.4593 46.5417 23.6252C46.5417 10.9193 36.2059 0.583496 23.5 0.583496ZM32.8813 37.121L30.0834 39.096V46.6668H16.9167V39.096L14.1188 37.121C9.67504 34.0268 7.04171 28.9906 7.04171 23.6252C7.04171 14.5402 14.415 7.16683 23.5 7.16683C32.585 7.16683 39.9584 14.5402 39.9584 23.6252C39.9584 28.9906 37.325 34.0268 32.8813 37.121Z"/>
                                </svg>
                            </div>
                            <div class="col-span-5 ml-2">
            ...
            <section class="bg-gray-300 px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 md:py-12 lg:py-14 dark:bg-dviolet dark:text-ghost">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 container max-w-screen-xl mx-auto">
                    <div class="justify-self-center">
                        <!-- animation -->
                        <img class="rounded-full shadow-vi dark:shadow-vindigo" src="images/about/animation_3.jpg" alt="Traffic Lights Animation created by Jessica Lee">
                    </div>
