                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8">
                        <div class="grid grid-cols-6 gap-x-2 md:gap-x-3">
                            <div class="mt-4 flex justify-center self-start">
                                <svg class="w-12 h-14 animate-bounce ease-in-out fill-dviolet dark:fill-ghost dark:border-ghost" viewBox="0 0 73 50" xmlns="http://www.w3.org/2000/svg" alt="Violet outlined eye icon" title="Bouncing eye icon">
                        ...
                        <div class="grid grid-cols-6 gap-x-2 md:gap-x-3">
                            <div class="mt-4 flex justify-center self-start">
                                <svg class="w-12 h-16 animate-bounce ease-in-out fill-dviolet dark:fill-ghost dark:border-ghost" viewBox="0 0 55 67" xmlns="http://www.w3.org/2000/svg" alt="Violet person with waving hand icon" title="Bouncing person with waving hand icon">
                        ...
                        <div class="grid grid-cols-6 gap-x-2 md:gap-x-3">
                            <div class="mt-4 flex justify-center self-start">
                                <svg class="w-12 h-14 animate-bounce ease-in-out fill-dviolet dark:fill-ghost dark:border-ghost" viewBox="0 0 47 67" xmlns="http://www.w3.org/2000/svg" alt="Violet outlined lightbulb icon" title="Bouncing lightbulb icon">
                        ...
                        <div class="grid grid-cols-6 gap-x-2 md:gap-x-3">
                            <div class="mt-4 flex justify-center self-start">
                                <svg class="w-16 h-12 animate-bounce ease-in-out fill-dviolet dark:fill-ghost dark:border-ghost" viewBox="0 0 67 55" xmlns="http://www.w3.org/2000/svg" alt="Violet waves icon" title="Bouncing waves icon">
