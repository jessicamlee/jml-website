...
<html lang="en-CA">
    ...
    <body class="bg-ghost text-dviolet font-medium text-sm lg:text-base">
        ...
        <main>
            <section class="px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 md:py-12 lg:py-14">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <div>
                        ...
                        <p class="leading-6 mt-0 md:mt-4 mb-3">I am currently studying New Media and Web Development to become a <b>Front&dash;End Developer</b> who specializes in the user&apos;s experience&period;</p>
            ...
            <section class="px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 md:py-12 lg:py-14 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
            ...
            <section class="bg-gray-300 px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 md:py-12 lg:py-14 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="justify-self-center">
                    <!-- animation -->
