        ...
        <main>
                ...
                <div class="container max-w-screen-lg mx-auto">
                    <div>
                        <div class="text-center">
                            ...
                            <p class="leading-6"><a href="#" target="_blank" title="Link to LOCLO Website Prototype"><b>Go to Prototype&colon;</b> <span class="border-b-4 border-dviolet border-solid xl:hover:border-dashed transition ease-in-out duration-700 delay-100 dark:border-white">LOCLO UX Design</span></a></p>
                        </div>
            ...
            <section id="project-details" class="px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 dark:bg-vindigo dark:text-white">
                <div class="container max-w-screen-lg mx-auto">
                    ...
                    <div>
                        ...
                        <p class="leading-6 my-4 md:px-20 lg:px-24 xl:px-40 text-left">The unmoderated usability studies were hosted on <a class="border-b-4 border-dviolet border-solid xl:hover:border-dashed transition ease-in-out duration-700 delay-75 dark:border-white" href="https://www.useberry.com/integrations/figma/" target="_blank" title="Link to Useberry Figma Integration page">Useberry</a> for the website and <a class="border-b-4 border-dviolet border-solid xl:hover:border-dashed transition ease-in-out duration-700 delay-75 dark:border-white" href="https://maze.co/use-cases/wireframe-and-usability-testing/" target="_blank" title="Link to Maze Usability Testing page">Maze</a> for the mobile application&period;</p>
            ...
            <section class="px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 dark:bg-vindigo dark:text-white">
                <div class="container max-w-screen-lg mx-auto">
                    ...
                    <p class="leading-6"><a href="#" target="_blank" title="Link to live site of LOCLO's Homepage"><b>Go to Website Live Site&colon;</b> <span class="border-b-4 border-dviolet border-solid xl:hover:border-dashed transition ease-in-out duration-700 delay-100 dark:border-white">LOCLO Homepage</span></a></p>
