    ...
    <body class="bg-ghost text-dviolet font-medium text-sm lg:text-base">
        ...
        <main>
            ...
            <section class="px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10 lg:py-14">
                <div>
                    <div class="text-center">
                        ...
                        <p class="leading-6"><a href="#" target="_blank" title="Link to live site of Get IEN Home"><b>Go to Live Site&colon;</b> Get IEN Home&excl;</a></p>
                    </div>
                    <a href="#" target="_blank" title="Visit Get IEN Home Live Site">
                        <img class="w-full xl:min-w-fit h-96 object-cover object-top overflow-hidden rounded-2xl shadow-vi mt-3" src="../images/projects/loclo_dev_1.jpg" alt="Get IEN Home Project Cover Photo">
                    </a>
            ...
            <section class="bg-dviolet text-ghost px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10">
                <ul class="xs:grid grid-rows-3 grid-flow-col gap-x-4 xs:gap-x-10 lg:gap-y-4">
                    ...
                    <li>
                        ...
                        <p class="font-normal">Expand my JavaScript knowledge by creating a game inspired by <a href="https://greensock.com/docs/v3/GSAP" target="_blank" title="Link to GSAP Timeline by GreenSock Documentation">GSAP Timeline by GreenSock</a>&period;</p>
                    </li>
                </ul>
            </section>
            ...
            <section class="px-10 xs:px-14 sm:px-18 md:px-24 lg:px-28 xl:px-32 py-10">
                ...
                <p class="leading-6 my-4 md:px-20 lg:px-24 xl:px-40 text-left">Another aspect is to integrate environmental obstacles to include consequences for hitting an obstacle that will make the game more relayable&period;</p>
            </section>
