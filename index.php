...
<html lang="en-CA">
    ...
    <body class="bg-ghost text-dviolet font-medium">
        ...
        ?>
        <main>
            <section class="bg-winter px-20 pt-8 lg:px-40 pt-8 pb-14">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <img src="images/jessicalee_favicon.svg" alt="JL Logo Animation">
                </div>
            ...
            <section class="bg-winter px-20 lg:px-40 py-14">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
