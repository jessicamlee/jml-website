...
<html lang="en-CA">
    ...
    ?>
    <body class="bg-ghost text-dviolet font-medium text-sm">
        <?php 
            $active_page = "home";
            require ('partials/global/header.php'); 
        ?>
        <main>
            <section class="bg-dviolet px-8 xs:px-12 sm:px-16 md:px-24 lg:px-28 xl:px-32 pt-8 md:pb-6 grid">
                <div class="grid-cols-2 gap-8">
                    ...
                    <!-- Logo Animation Here -->
                    <div>
                        <img class="self-center w-1/2" src="images/jessicalee_favicon.svg" alt="JL Logo Animation">
                    </div>
                </div>
            ...
            <section id="projects" class="px-8 xs:px-12 sm:px-16 md:px-24 lg:px-28 xl:px-32 py-10 lg:py-14">
                <h2 class="font-semibold text-3xl lg:text-4xl xl:text-5xl leading-relaxed mb-1.5">Projects</h2>
                <div class="mt-4 grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-y-8 gap-x-4">
