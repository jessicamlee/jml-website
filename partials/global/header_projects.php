<header id="header" data-aos="fade-down">
    <div class="container header-bar flex">
        ...
        <nav class="gn">
            <ul class="flex">
                <li data-aos="fade-down" data-aos-delay="600"><a href="../index.php" title="Projects by Jessica">Projects</a></li>
                <li data-aos="fade-down" data-aos-delay="800"><a href="../index.php" title="Who is Jessica?">About</a></li>
