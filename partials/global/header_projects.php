...
?><header id="header" class="box-shadow-light" data-aos="fade-down">
    <div class="container header-bar flex">
        ...
        <nav class="gn box-shadow-gn">
            <ul class="flex">
                <li class=" <?php if($active_page == "development") { echo "active"; } ?>" data-aos="fade-down" data-aos-delay="600"><a href="../index.php" title="Projects by Jessica">Projects</a></li>
                <li class=" <?php if($active_page == "about") { echo "active"; } ?>" data-aos="fade-down" data-aos-delay="800"><a href="../index.php" title="Who is Jessica?">About</a></li>
