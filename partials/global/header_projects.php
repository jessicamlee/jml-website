...
?><header id="header" class="py-4 px-6 2xs:px-10 xs:px-14 sm:px-18 lg:px-24 shadow-vi-light">
    <div class="flex container max-w-screen-xl mx-auto">
        <a class="basis-1/5 flex justify-start" href="../index.php" title="Home Page">
        ...
        <nav class="basis-2/5 xs:mt-0 flex items-center justify-end">
            <ul class="xs:flex text-sm 2xs:text-base uppercase leading-3 font-semibold text-right space-y-4 2xs:space-y-1 xs:space-y-0 text-dviolet">
                <li class="xs:mr-4 <?php if($active_page == "development") { echo "active"; } ?>"><a class="xl:hover:border-b-4 xl:hover:border-dviolet border-solid xl:hover:border-dashed transition ease-in-out duration-700 delay-100 dark:border-white" href="../index.php" title="Projects by Jessica">Projects</a></li>
                <li class="<?php if($active_page == "contact") { echo "active"; } ?>"><a class="xl:hover:border-b-4 xl:hover:border-dviolet border-solid xl:hover:border-dashed transition ease-in-out duration-700 delay-100 dark:border-white" href="#contact" title="Contact Jessica">Contact</a></li>
            </ul>
        </nav>
    </div>
</header>