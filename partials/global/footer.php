<footer id="contact" class="pt-6">
    <div class="xs:flex flex-row pt-8 px-8 xs:px-12 sm:px-16 md:px-24 lg:px-28 xl:px-32">
        ...
        <div class="basis-1/5 h-10"></div>
        <ul class="basis-2/5 text-center self-end xs:text-right text-base md:text-lg">
    ...
    <div class="bg-dviolet py-7 mt-8">
        <p class="px-12 font-normal text-center text-ghost">&copy; 2022 Jessica Lee&period; All Rights Reserved&period;</p>
    </div>
</footer>