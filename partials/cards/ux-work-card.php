<?php
    ...
    $ux_project_role = $ux_project_role ?? '';
    $ux_project_timeline = $ux_project_timeline ?? '';
    $ux_project_context = $ux_project_context ?? '';

?><div class="container flex cs-summary cs-flex-tablet">
    <div>
        <h1><?php echo $ux_project_title; ?></h1>
        <p><span class="bolded">Role&colon;</span> <?php echo $ux_project_role; ?></p>
        <p><span class="bolded">Timeline&colon;</span> <?php echo $ux_project_timeline; ?></p>
        <p><span class="bolded">Company&colon;</span> <?php echo $ux_project_context; ?></p>
    </div>
