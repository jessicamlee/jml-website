<section class="ux-projects subpg-section">
    <div class="container">
        <h2 data-aos="fade-right" data-aos-delay="350">User Experience &lpar;UX&rpar; Design</h2>
        <ul class="ux-collection collection-container flex" data-aos="fade-right" data-aos-delay="400">
            ...
            <?php
                ...
                $project_skills = 'Web Design | Adobe XD | Moderated Testing';
                ...
                $prototype_link = 'https://drive.google.com/file/d/13pmYpUx9GkdeeyKfE-AIxSh9A3ptIFmn/view?usp=sharing';
                include('partials/cards/ux-card.php');
            ?>
            <?php
                $project_title = 'Vancity Sushi';
                $project_desc = 'Food Ordering Experience';
                $project_skills = 'App Design | Figma | Moderated Testing';
                ...
                $prototype_link = 'https://drive.google.com/file/d/1x928v_RJbuuzggUkIPV9HQDVG_aQzfrA/view?usp=sharing';
                include('partials/cards/ux-card.php');                
            ?>
        </ul>
    </div>
