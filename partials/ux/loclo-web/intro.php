<section class="subpg-section">
    <div class="container">
        <?php
            ...
            $ux_project_roles = 'UX Designer, UX Researcher (Unmoderated Usability Testing)';
            $ux_project_timeline = '5 Weeks';
        ...
        <div class="cs-section flex cs-intro cs-flex-tablet">
            ...
            <div class="cs-half-width">
                ...
                <ul>
                    ...
                    <li>Test and revise the shopping experience to feel less overwhelming</li>
