        ...
        <div class="cs-subsection">
            ...
            <div class="flex cs-flex-tablet">
                <div class="cs-half-width">
                    <p>I started with my handy pen and paper to output ideas using the Crazy Eights and the How Might We methods to generate ideas and return to the empathetic state of mind to prioritize the most important benefits to create features for&period;</p>
            ...
            <div class="flex cs-flex-tablet cs-tablet-rr">
                <div class="cs-half-width">
                    <p>In the pen&dash;and&dash;paper wireframe examples&comma; I brainstormed different layouts for the Home screen and focused on outputting many ideas before revisiting the wireframes and refining a final wireframe to pursue this sprint&period;</p>
            ...
            <p>Following the pen&dash;and&dash;paper wireframes&comma; I repeated the above method to work on building the other screens and creating the digital wireframes for the Minimum Viable Product of the Vancity Sushi app&period;</p>
        </div>
    </div>
</section>