<section class="subpg-section">
    <div class="container cs-section">
        ...
        <div class="cs-subsection">
            <p>After creating the wireframes&comma; I moved forward with the low&dash;fidelity and high&dash;fidelity prototypes&period; Following each prototype&comma; I conducted a moderated Usability Study to learn about unaddressed pain points&period; Listed below are the key findings from each round&period;</p>
            <h4>Round 1 Key Findings&colon;</h4>
            <ul class="mb-md">
                <li>Users want more guidance and visual cues to navigate the app&period;</li>
                <li>Users want a simple Menu page to find everything quicker&period;</li>
                <li>Users want an Updated Payment page to understand how the points affect their purchases&period;</li>
            </ul>
            ...
            <h4>Round 2 Key Findings&colon;</h4>
            <ul class="mb-md">
                <li>Users want an option to remove items from the Cart when they change their minds about the items&period;</li>
                <li>Users want to know where and when Address information is requested for the Delivery option and additional fees&period;</li>
                <li>Users want to see Blank Fields on the Payment page to have the option to select fields to complete&period;</li>
            </ul>
            <div class="flex cs-flex-tablet mt-lg">
                <div class="img-container cs-body-img-container cs-half-width">
        ...
        <div class="cs-subsection">
            ...
            <p>From reviewing how the changes impacted the users&apos; experiences between usability study &#35;1 and usability study &#35;2&comma; I revisited how the overall design for these two sprints addressed the challenges defined at the beginning of this project&period;</p>
            <div class="flex cs-flex-tablet mt-lg cs-items-center">
                <div class="cs-half-width">
                    <h4><span class="is-uppercase bolded">Challenge 1&colon;</span> Familiar, mobile-friendly experience</h4>
                    <p>Vancity Sushi&apos;s competition becomes more tense as more restaurants turn to food apps to keep their customers&period;</p>
            ...
            <div class="flex cs-flex-tablet mt-lg cs-tablet-rr cs-items-center">
                <div class="cs-half-width">
                    <h4><span class="is-uppercase bolded">Challenge 2&colon;</span> Inconsistent or absence of Images in Menu</h4>
                    <p>When Vancity Sushi launched its website ordering platform&comma; the main focus was on receiving the order&period;</p>
            ...
            <div class="flex cs-flex-tablet mt-lg cs-items-center">
                <div class="cs-half-width">
                    <h4><span class="is-uppercase bolded">Challenge 3&colon;</span> Simple and easy to use</h4>
                    <p>The most important factor to consider is the user&dash;friendly component&period;</p>
        ...
        <p class="text-center">To view the changes&comma; check out the <a class="bolded" href="https://www.figma.com/proto/0fJVrmtoCg0EExO6IxF8Vm/mobile-app-vers.-2?page-id=123%3A2&node-id=123%3A668&viewport=241%2C48%2C0.38&scaling=scale-down&starting-point-node-id=123%3A668" target="_blank" title="Link to Low-fidelity Prototype of The Vancity Sushi App">high&dash;fidelity prototype here</a>&period;</p>
    </div>
</section>