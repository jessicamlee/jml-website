<section class="subpg-section container">
    <div class="cs-section">
        ...
        <p>By conducting <span class="bolded">A&sol;B testing</span> to better understand user payment decisions and preferences&comma; my team and I could <span class="bolded">confidently modify interface placements from users&apos; feedback</span>&period;</p>
        <p>With this testing approach&comma; we could stay on schedule within the project&apos;s timeline&period;</p>
        <div class="img-container cs-body-img-container">
            <img class="img-thumb" src="images/case-studies/psyhealth/psyhealth_iterations_paymentcta_after.jpg" alt="Final layout for the Why Psystem section on the Discover Page, making use of the negative space intentionally">
            <p class="cs-img-caption">The After wireframes of PsyHealth&apos;s Subscription&dash;Payment Call&dash;to&dash;action screen&period;</p>
        </div>
    </div>
</section>