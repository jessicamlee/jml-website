<section class="subpg-section">
    <div class="container">
        <?php
            ...
            $ux_project_context = 'Psystem provides health and wellness coaching solutions to help manage chronic pain and mental health.';
            include('partials/cards/ux-work-card.php');
        ?>
        <div class="cs-section tldr-details">
            <h2>Overview</h2>
            <p><span class="bolded">Status&colon;</span> Deployed&excl;</p>
            <p><span class="bolded">Team&colon;</span> Product Owner &lpar;a&period;k&period;a&period; Psystem&apos;s Founder&rpar;</p>
            <p><span class="bolded">Achievements&colon;</span> Transformed 5 web pages into Ad Landing Pages for 2023 marketing campaigns</p>
        ...
        <div class="cs-section">
            ...
            <h3>Approach&colon; Empathize → Define → Ideate → Iterate → Test</h3>
