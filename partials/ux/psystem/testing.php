<section class="subpg-section container">
    <div class="cs-section">
        <h2>Refining for Journey Completion</h2>
        <p>Using the Webflow Staging Domains and our in&dash;house testers&comma; I evaluated&colon;</p>
        <ul>
            <li><span class="bolded">Navigation efficiency</span> with updated menus</li>
        ...
        <p>Another round of testing revealed <span class="bolded">increased user satisfaction and engagement</span> as our mobile testers <span class="bolded">did not feel as fatigued</span> to navigate between pages&period;</p>
    </div>  
</section>