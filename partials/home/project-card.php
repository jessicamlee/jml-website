    ...
    <div class="project-thumb">
        ...
        <div class="links-container flex">
            ...
            <div class="btn-container flex">
                <a class="live-link box-shadow-light" href="<?php echo $live_link; ?>" target="_blank" title="Visit Live Site">Visit Site</a>
                <a class="code-link box-shadow-light" href="<?php echo $code_link; ?>" target="_blank" title="Visit GitHub Repository">Review Code</a>
            </div>
        </div>
    </div>
</li>